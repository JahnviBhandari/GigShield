        ...
        <div className="stat-card">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex-1">
              <h2 className="font-bold text-lg">{workerProfile.name}</h2>
          ...
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-xs text-muted-foreground">{workerProfile.vehicleType} • {workerProfile.zone}</span>
          </div>
          <div className="grid grid-cols-3 gap-3 text-center">
            <div className="rounded-lg bg-muted/50 p-2">
              <p className="text-xs text-muted-foreground">Premium/wk</p>
              <p className="font-bold text-sm">₹{workerProfile.weeklyPremium}</p>
            </div>
            <div className="rounded-lg bg-muted/50 p-2">
